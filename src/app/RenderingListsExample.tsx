...
export default function RenderingListsExample() { return <article><h1 className="text-xl">x certain type of people</h1><ul>{people.map(({ id, name, profession, accomplishments, imgId }) => (
